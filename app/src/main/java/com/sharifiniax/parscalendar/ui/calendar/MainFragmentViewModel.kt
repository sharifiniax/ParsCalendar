...
class MainFragmentViewModel @Inject constructor(private val repositoryImpl: CalendarRepositoryImpl) :
    ...
    private val today = MutableLiveData(repositoryImpl.today())
//    private val today=liveData<DayModel>{
//    Logger.d("start LiveData")
//        coroutineScope {
//            launch(Dispatchers.IO) {
//                repositoryImpl.getToday().
//                collect{
//                    Logger.d("emit LiveData $it")
//                    emit(it)
//                }
//            }
//        }
...
//    }
    ...
    private val _jalaliEventTitles:MutableLiveData<List<PublicEvent>?> =
